...
def main(today_date, country_list, data_queried, files_processed, replenishment_done):
    ...
    for country in country_list:
        ...
        if not data_queried:
            ...
            write_to_csv(sql_queries.get_brands(country, str_four_weeks_ago_date, str_two_weeks_ago_date, str_yesterday_date),
                         file_names['brand'])
...
if __name__ == '__main__':
    ...
    main(args.date, args.countries, args.queried, args.processed, args.rep_done)
